...
public class Q10 {
    ...
    int gst;
    int quantity;
    Q10(int id, String name, int price, int gst, int quantity) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.gst = gst;
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Q10> list = new ArrayList<>();
        ArrayList<Q10> cart = new ArrayList<>();
        ArrayList<Integer> qty = new ArrayList<>();

        try {
            BufferedReader buff = new BufferedReader(new FileReader("C:\\Users\\Coditas-Admin\\IdeaProjects\\Assignment1\\src\\Products.txt"));
            String line;
...
//                int id = Integer.parseInt(line.substring(0,indSpace));
                ...
                list.add(new Q10(id,name,price,gst,quantity));
            }
            buff.close();
